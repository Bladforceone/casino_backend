...
func NewCascadeStatsRepository() repository.CascadeStatsRepository {
	return &statsRepo{
		data: GameStats{
...
func (r *statsRepo) switchIndex(direction int) {
	...
	log.Printf("[Cascade] Switched to config index %d", r.data.CurrentIndex)
}
